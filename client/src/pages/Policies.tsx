...
import CheckoutForm from '../components/CheckoutForm'; // Crear un nuevo componente para el formulario de pago
...
const Policies = () => {
  ...
  const handleSelectPolicy = async (policy: string) => {
    ...
    try {
      ...
      setErrorMessage('Error al crear la póliza o procesar el pago. Intenta nuevamente.');
      console.error('Error en la creación de póliza o pago:', error);
        ...
        <div className="mt-8 w-full max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <Elements stripe={stripePromise}>
              <CheckoutForm clientSecret={paymentIntent} policy={selectedPolicy} />
            </Elements>
          </div>
        </div>
      )}
