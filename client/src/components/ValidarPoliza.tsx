      ...
      <div className="max-w-6xl mx-auto py-10 px-6 mt-16">
        ...
        <div className="mb-8 flex justify-center space-x-4">
          <input
            ...
            className="px-4 py-2 rounded-lg text-black bg-white w-1/2 focus:outline-none focus:ring-2 focus:ring-blue-600 border border-gray-300"
          />
          <button
        ...
        <table className="min-w-full table-auto bg-white rounded-lg shadow-lg border border-gray-200">
          ...
          <tbody>
            {polizas.length > 0 ? (
              polizas.map((poliza) => (
                <tr key={poliza.polizaid} className="border-t border-gray-200">
