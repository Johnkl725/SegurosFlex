...
--
/*!50003 DROP PROCEDURE IF EXISTS `CreateProveedor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `CreateProveedor`(
    IN p_Nombre_Proveedor VARCHAR(255),
    IN p_Dirección VARCHAR(255),
    IN p_Teléfono_Proveedor VARCHAR(20),
    IN p_Correo_Electrónico VARCHAR(100),
    IN p_Tipo_Proveedor VARCHAR(100),
    IN p_Estado_Proveedor ENUM('Activo', 'Inactivo'),
    IN p_Valoración DECIMAL(3,2),
    IN p_Notas TEXT
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteProveedor`(IN p_ID_Proveedor INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `GetProveedorById` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetProveedorById`(IN p_ID_Proveedor INT)
BEGIN
...
-- Dump completed on 2025-01-30 22:48:14
